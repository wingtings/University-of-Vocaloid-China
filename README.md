...
1. 访问 wiki.feixilu.top 任意文章，右上角标题旁会出现铅笔图标（编辑）和眼睛图标（查看源码）
2. 点铅笔 → 跳转到 GitHub 在线编辑器
3. 成员需要：

- 有 GitHub 账号（点编辑会提示登录）
- 没有仓库写权限的人改完，GitHub 会自动引导他们 Fork + 提 Pull Request，由 [wingtings](https://github.com/wingtings/) 审核合并
- 给谁直接写权限：仓库 → Settings → Collaborators 邀请即可
